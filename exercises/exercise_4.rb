...
# Your code goes here ...
store4 = Store.create(name: "Surrey", annual_revenue: 240000, mens_apparel: false, womens_apparel: true)

store5 = Store.create(name: "Whistler", annual_revenue: 1900000, mens_apparel: true, womens_apparel: false)

store6 = Store.create(name: "Yaletown", annual_revenue: 240000, mens_apparel: true, womens_apparel: true)
